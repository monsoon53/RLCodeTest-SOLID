...
However, I felt that the project could be improved in some areas. Should the requirements for the application be changed to make it more extendable, and as compliant as possible with the SOLID Principles, these are the changes that I would make:
